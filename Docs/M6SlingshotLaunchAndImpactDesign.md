...
该固定步长二体模型是参数认证与 M3R-4.1 预筛边界，不是生产 M6/M9 实飞的第二权威。Launch/Preset 参数 V0 已于 2026-07-31 完成可见 PIE 手感验收，并通过稳定原生 factory 交给 M3；这仍不等于月度 Ballistic Witness 已由生产链验证，R-4.1 必须继续消费经批准的只读生产适配器。
