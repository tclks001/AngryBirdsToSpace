...
`FABTSM5InventoryHUDData::ResolveLayout` 只接收视口尺寸和 Theme 快照，统一产出绘制与命中盒坐标。自动化覆盖 1024×600、1280×720 和 1920×1080，验证热栏/模态框不越界、左右面板不相交、八个热栏格稳定、16 个现行物品图标路径非空且唯一，以及 8 个按钮象形图 UV 完整、唯一且不越界。
