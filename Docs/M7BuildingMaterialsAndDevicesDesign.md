...
>
> 子设计稿：[物理碰撞破坏爽感调研](PhysicsImpactDestructionResearch.md) · [M7 球面 TaskGraph 集成](M7TaskGraphSphericalBuildingIntegrationDesign.md) · [M7.1 平面物理测试台](M71PlanarPhysicsTestStageDesign.md) · [M7.3 程序化模块化建筑总体算法](M73ProceduralModularBuildingGenerationResearch.md)。手工搭建平面碰撞关卡、摆放四材质砖与四档完整弹弓的独立测试入口见 [M71PlanarPhysicsTestStageDesign.md](M71PlanarPhysicsTestStageDesign.md)。
>
