...
const FFixedSixV3SiteIdentity& GetFixedSixV3SiteIdentity(const int32 Index)
{
	static const FFixedSixV3SiteIdentity Identities[] = {
		...
		{TEXT("E3SlideRelease"), 2, 750137, 17275427342821674139ull,
			6383393652673249871ull, 7236097625667045547ull,
			1370505189594638717ull,
			FBox(FVector(-378.0, -522.0, 0.0), FVector(378.0, 882.0, 1260.0)),
			FBox(FVector(-414.0, -558.0, 0.0), FVector(414.0, 918.0, 1260.0)),
			FBox(FVector(-486.0, 630.0, -252.0), FVector(-126.0, 990.0, 468.0)),
			EABTSJuryDemoFixedSixSurfaceKind::PrimaryPlanet},
		{TEXT("E4TipOver"), 3, 730000, 11958914991675952679ull,
			9740768898456456024ull, 13697044403857963264ull,
			4799465417505627064ull,
			FBox(FVector(-306.0, -234.0, 0.0), FVector(306.0, 666.0, 1728.0)),
			FBox(FVector(-342.0, -270.0, 0.0), FVector(342.0, 702.0, 1728.0)),
			FBox(FVector(-414.0, 414.0, -252.0), FVector(-54.0, 774.0, 468.0)),
			EABTSJuryDemoFixedSixSurfaceKind::PrimaryPlanet},
		{TEXT("E5SeamRelease"), 4, 720000, 1989331262975175792ull,
			10330658710889900958ull, 6534661451021924589ull,
			15789667465719189998ull,
			FBox(FVector(-450.0, -234.0, 0.0), FVector(450.0, 954.0, 1260.0)),
			FBox(FVector(-486.0, -270.0, 0.0), FVector(486.0, 990.0, 1260.0)),
			FBox(FVector(-558.0, 450.0, -144.0), FVector(-198.0, 1170.0, 216.0)),
			EABTSJuryDemoFixedSixSurfaceKind::PrimaryPlanet},
		...
		{TEXT("E6TipOver"), 5, 750000, 13541894710153562482ull,
			14403404921362406396ull, 13444637963928735160ull,
			15174068973385450659ull,
			FBox(FVector(-306.0, -270.0, 0.0), FVector(306.0, 702.0, 2016.0)),
			FBox(FVector(-342.0, -306.0, 0.0), FVector(342.0, 738.0, 2016.0)),
			FBox(FVector(-414.0, 450.0, -252.0), FVector(-54.0, 810.0, 468.0)),
			EABTSJuryDemoFixedSixSurfaceKind::PrimaryPlanet}
	};
	check(Index >= 0 && Index < UE_ARRAY_COUNT(Identities));
	return Identities[Index];
