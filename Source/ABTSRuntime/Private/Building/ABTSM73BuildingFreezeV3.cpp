...
FABTSM73BuildingFreezeV3::GetFrozenIdentities()
{
	...
	static const TArray<FABTSM73BuildingFreezeV3FrozenIdentity> Frozen = {
		...
		MakeFrozen(EABTSM73BeamDemoBuilding::E3SlideRelease, 1,
			EABTSM7BuildingMaterial::Wood, 2, 750137, 242, 1, 0,
			Histogram(242, 0, 0, 0, 0),
			FBox(FVector(-882, -378, 0), FVector(522, 378, 1260)),
			FBox(FVector(-378, -522, 0), FVector(378, 882, 1260)),
			FBox(FVector(-414, -558, 0), FVector(414, 918, 1260)),
			FBox(FVector(-486, 630, -252), FVector(-126, 990, 468)),
			14850675898370123070ull, 1370505189594638717ull, 0ull,
			6383393652673249871ull, 7236097625667045547ull,
			17275427342821674139ull),
		MakeFrozen(EABTSM73BeamDemoBuilding::E4TipOver, 2,
			EABTSM7BuildingMaterial::Stone, 3, 730000, 211, 1, 0,
			Histogram(0, 211, 0, 0, 0),
			FBox(FVector(-666, -306, 0), FVector(234, 306, 1728)),
			FBox(FVector(-306, -234, 0), FVector(306, 666, 1728)),
			FBox(FVector(-342, -270, 0), FVector(342, 702, 1728)),
			FBox(FVector(-414, 414, -252), FVector(-54, 774, 468)),
			11920302458236152422ull, 4799465417505627064ull, 0ull,
			9740768898456456024ull, 13697044403857963264ull,
			11958914991675952679ull),
		MakeFrozen(EABTSM73BeamDemoBuilding::E5SeamRelease, 3,
			EABTSM7BuildingMaterial::Iron, 4, 720000, 249, 1, 0,
			Histogram(0, 0, 249, 0, 0),
			FBox(FVector(-954, -450, 0), FVector(234, 450, 1260)),
			FBox(FVector(-450, -234, 0), FVector(450, 954, 1260)),
			FBox(FVector(-486, -270, 0), FVector(486, 990, 1260)),
			FBox(FVector(-558, 450, -144), FVector(-198, 1170, 216)),
			16865627090315594965ull, 15789667465719189998ull, 0ull,
			10330658710889900958ull, 6534661451021924589ull,
			1989331262975175792ull),
		...
		MakeFrozen(EABTSM73BeamDemoBuilding::E6TipOver, 5,
			EABTSM7BuildingMaterial::Iron, 5, 750000, 226, 1, 0,
			Histogram(0, 0, 226, 0, 0),
			FBox(FVector(-702, -306, 0), FVector(270, 306, 2016)),
			FBox(FVector(-306, -270, 0), FVector(306, 702, 2016)),
			FBox(FVector(-342, -306, 0), FVector(342, 738, 2016)),
			FBox(FVector(-414, 450, -252), FVector(-54, 810, 468)),
			17368142929893232566ull, 15174068973385450659ull, 0ull,
			14403404921362406396ull, 13444637963928735160ull,
			13541894710153562482ull)};
	return Frozen;
}
